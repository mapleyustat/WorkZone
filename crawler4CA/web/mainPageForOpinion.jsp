...
<% String text = request.getParameter("input");
    ...
    System.out.println("inputHere = "+text);
    System.out.println("inputHere = "+sentVal);
...
//                                                    System.out.println("asdfNEG"+vnegTitle);
                                    ...
                                    if(this.series.name=="Positive") {
                                        ...
                                        $report.html(
                                                ...
                                                %>
                                                '<tr><td>'+this.series.name+'</td><td><a href='+"<%=posTitle.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=posDate.get(tempTitle)%>"+'</td><td><%=posSource.get(tempTitle)%></td><td><select class="positive" id="op<%=tempTitle%>" data-news="<%=posTitle.get(tempTitle)%>"><option value="0.5" selected="selected">Positive</option><option value="1">Very Positive</option><option value="0">Neutral</option><option value="-0.5">Negative</option><option value="-1">Very Negative</option></select></td></tr>'+
                                                <%}%>
                                                '</table>'+
                                                '<script type="text/javascript">'+
                                                        'fire_on_event();'+
                                       ...
                                       %>
                                        $report.html('<table>'+
                                                ...
                                                %>
                                                '<tr><td>'+this.series.name+'</td><td><a href='+"<%=neutTitle.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=neutDate.get(tempTitle)%>"+'</td><td><%=neutSource.get(tempTitle)%></td><td><select class="neutral" id="op<%=tempTitle%>" data-news="<%=neutTitle.get(tempTitle)%>"><option value="0.5">Positive</option><option value="1">Very Positive</option><option value="0" selected="selected">Neutral</option><option value="-0.5">Negative</option><option value="-1">Very Negative</option></select></td></tr>'+
                                                <%}%>
                                                '</table>'+
                                                        '<script type="text/javascript">'+
                                                        'fire_on_event();'+
                                       ...
                                       %>
                                        $report.html('<table>'+
                                                ...
                                                %>
                                                '<tr><td>'+this.series.name+'</td><td><a href='+"<%=vnegTitle.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=vnegDate.get(tempTitle)%>"+'</td><td><%=vnegSource.get(tempTitle)%></td><td><select class="veryNegative" id="op<%=tempTitle%>" data-news="<%=vnegTitle.get(tempTitle)%>"><option value="0.5">Positive</option><option value="1">Very Positive</option><option value="0" >Neutral</option><option value="-0.5">Negative</option><option value="-1" selected="selected">Very Negative</option></select></td></tr>'+
                                                <%}%>
                                                '</table>'+
                                                        '<script type="text/javascript">'+
                                                        'fire_on_event();'+
                                       ...
                                       %>
                                        $report.html('<table>'+
                                                ...
                                                %>
                                                '<tr><td>'+this.series.name+'</td><td><a href='+"<%=vposTitle.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=vposDate.get(tempTitle)%>"+'</td><td><%=vposSource.get(tempTitle)%></td><td><select class="veryPositive" id="op<%=tempTitle%>" data-news="<%=vposTitle.get(tempTitle)%>"><option value="0.5">Positive</option><option value="1" selected="selected">Very Positive</option><option value="0">Neutral</option><option value="-0.5">Negative</option><option value="-1">Very Negative</option></select></td></tr>'+
                                                <%}%>
                                                '</table>'+
                                                        '<script type="text/javascript">'+
                                                        'fire_on_event();'+
...
//                                                    System.out.println("asdfNEG"+vnegTitleW);
                                    ...
                                    if(this.series.name=="Positive") {
                                        ...
                                        $report.html('<table>'+
                                                ...
                                                %>
                                                '<tr><td>'+this.series.name+'</td><td><a href='+"<%=posTitleW.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=posDateW.get(tempTitle)%>"+'</td><td><%=posSourceW.get(tempTitle)%></td><td><select class="positive" id="op<%=tempTitle%>" data-news="<%=posTitleW.get(tempTitle)%>"><option value="0.5" selected="selected">Positive</option><option value="1">Very Positive</option><option value="0">Neutral</option><option value="-0.5">Negative</option><option value="-1">Very Negative</option></select></td></tr>'+
                                                <%}%>
                                                '</table>'+
                                                        '<script type="text/javascript">'+
                                                        'fire_on_event();'+
                                        ...
                                        $report.html('<table>'+
                                                ...
                                                %>
                                                '<tr><td>'+this.series.name+'</td><td><a href='+"<%=negTitleW.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=negDateW.get(tempTitle)%>"+'</td><td><%=negSourceW.get(tempTitle)%></td><td><select class="negative" id="op<%=tempTitle%>" data-news="<%=negTitleW.get(tempTitle)%>"><option value="0.5">Positive</option><option value="1">Very Positive</option><option value="0">Neutral</option><option value="-0.5" selected="selected">Negative</option><option value="-1">Very Negative</option></select></td></tr>'+
                                                <%}%>
                                                '</table>'+
                                                        '<script type="text/javascript">'+
                                                        'fire_on_event();'+
                                       ...
                                       %>
                                        $report.html('<table>'+
                                                ...
                                                %>
                                                '<tr><td>'+this.series.name+'</td><td><a href='+"<%=vnegTitleW.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=vnegDateW.get(tempTitle)%>"+'</td><td><%=vnegSourceW.get(tempTitle)%></td><td><select class="veryNegative" id="op<%=tempTitle%>" data-news="<%=vnegTitleW.get(tempTitle)%>"><option value="0.5">Positive</option><option value="1">Very Positive</option><option value="0" >Neutral</option><option value="-0.5">Negative</option><option value="-1" selected="selected">Very Negative</option></select></td></tr>'+
                                                <%}%>
                                                '</table>'+
                                                        '<script type="text/javascript">'+
                                                        'fire_on_event();'+
                                       ...
                                       %>
                                        $report.html('<table>'+
                                                ...
                                                %>
                                                '<tr><td>'+this.series.name+'</td><td><a href='+"<%=vposTitleW.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=vposDateW.get(tempTitle)%>"+'</td><td><%=vposSourceW.get(tempTitle)%></td><td><select class="veryPositive" id="op<%=tempTitle%>" data-news="<%=vposTitleW.get(tempTitle)%>"><option value="0.5">Positive</option><option value="1" selected="selected">Very Positive</option><option value="0">Neutral</option><option value="-0.5">Negative</option><option value="-1">Very Negative</option></select></td></tr>'+
                                                <%}%>
                                                '</table>'+
                                                        '<script type="text/javascript">'+
                                                        'fire_on_event();'+
...
//                                                    System.out.println("asdfNEG"+vnegTitleM);
                                    ...
                                    if(this.series.name=="Positive") {
                                        ...
                                        $report.html('<table>'+
                                                ...
                                                %>
                                                '<tr><td>'+this.series.name+'</td><td><a href='+"<%=posTitleM.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=posDateM.get(tempTitle)%>"+'</td><td><%=posSourceM.get(tempTitle)%></td><td><select class="positive" id="op<%=tempTitle%>" data-news="<%=posTitleM.get(tempTitle)%>"><option value="0.5" selected="selected">Positive</option><option value="1">Very Positive</option><option value="0">Neutral</option><option value="-0.5">Negative</option><option value="-1">Very Negative</option></select></td></tr>'+
                                                <%}%>
                                                '</table>'+
                                                        '<script type="text/javascript">'+
                                                        'fire_on_event();'+
                                        ...
                                        $report.html('<table>'+
                                                ...
                                                %>
                                                '<tr><td>'+this.series.name+'</td><td><a href='+"<%=negTitleM.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=negDateM.get(tempTitle)%>"+'</td><td><%=negSourceM.get(tempTitle)%></td><td><select class="negative" id="op<%=tempTitle%>" data-news="<%=negTitleM.get(tempTitle)%>"><option value="0.5">Positive</option><option value="1">Very Positive</option><option value="0">Neutral</option><option value="-0.5" selected="selected">Negative</option><option value="-1">Very Negative</option></select></td></tr>'+
                                                <%}%>
                                                '</table>'+
                                                        '<script type="text/javascript">'+
                                                        'fire_on_event();'+
                                       ...
                                       %>
                                        $report.html('<table>'+
                                                ...
                                                %>
                                                '<tr><td>'+this.series.name+'</td><td><a href='+"<%=neutTitleM.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=neutDateM.get(tempTitle)%>"+'</td><td><%=neutSourceM.get(tempTitle)%></td><td><select class="neutral" id="op<%=tempTitle%>" data-news="<%=neutTitleM.get(tempTitle)%>"><option value="0.5">Positive</option><option value="1">Very Positive</option><option value="0" selected="selected">Neutral</option><option value="-0.5">Negative</option><option value="-1">Very Negative</option></select></td></tr>'+
                                                <%}%>
                                                '</table>'+
                                                        '<script type="text/javascript">'+
                                                        'fire_on_event();'+
                                       ...
                                       %>
                                        $report.html('<table>'+
                                                ...
                                                %>
                                                '<tr><td>'+this.series.name+'</td><td><a href='+"<%=vposTitleM.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=vposDateM.get(tempTitle)%>"+'</td><td><%=vposSourceM.get(tempTitle)%></td><td><select class="veryPositive" id="op<%=tempTitle%>" data-news="<%=vposTitleM.get(tempTitle)%>"><option value="0.5">Positive</option><option value="1" selected="selected">Very Positive</option><option value="0">Neutral</option><option value="-0.5">Negative</option><option value="-1">Very Negative</option></select></td></tr>'+
                                                <%}%>
                                                '</table>'+
                                                        '<script type="text/javascript">'+
                                                        'fire_on_event();'+
...
//                                                    System.out.println("asdfNEG"+vnegTitleSum);
                                    ...
                                    if(this.series.name=="Overall Sentiments") {
                                        ...
                                        $report.html('<table>'+
                                                ...
                                                %>
                                                '<tr><td>Positive</td><td><a href='+"<%=posTitleSum.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=posDateSum.get(tempTitle)%>"+'</td><td><%=posSourceSum.get(tempTitle)%></td><td><select class="positive" id="op<%=tempTitle%>" data-news="<%=posTitleSum.get(tempTitle)%>"><option value="0.5" selected="selected">Positive</option><option value="1">Very Positive</option><option value="0">Neutral</option><option value="-0.5">Negative</option><option value="-1">Very Negative</option></select></td></tr>'+
                                                <%
                                                }
                                                }
                                                %>
                                                ...
                                                %>
                                                '<tr><td>Negative</td><td><a href='+"<%=negTitleSum.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=negDateSum.get(tempTitle)%>"+'</td><td><%=negSourceSum.get(tempTitle)%></td><td><select class="negative" id="op<%=tempTitle%>" data-news="<%=negTitleSum.get(tempTitle)%>"><option value="0.5">Positive</option><option value="1">Very Positive</option><option value="0">Neutral</option><option value="-0.5" selected="selected">Negative</option><option value="-1">Very Negative</option></select></td></tr>'+
                                                <%
                                                }
                                                }
                                                %>
                                                ...
                                                %>
                                                '<tr><td>Neutral</td><td><a href='+"<%=neutTitleSum.get(tempTitle)%>"+' target = "_blank">'+"<%=replacingQuotes%>"+'</a></td><td>'+"<%=neutDateSum.get(tempTitle)%>"+'</td><td><%=neutSourceSum.get(tempTitle)%></td><td><select class="neutral" id="op<%=tempTitle%>" data-news="<%=neutTitleSum.get(tempTitle)%>"><option value="0.5">Positive</option><option value="1">Very Positive</option><option value="0" selected="selected">Neutral</option><option value="-0.5">Negative</option><option value="-1">Very Negative</option></select></td></tr>'+
                                                <%
                                                }
                                                }
                                                %>
