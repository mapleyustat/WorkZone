 ...
 */
public class PropertyGuruClassifier {


    private PropertyGuruClassifier() {}
    ...
    public static void main(String[] args) throws Exception {
        ...
        //object
        PropertyGuruClassifier obj = new PropertyGuruClassifier();
//        obj.newsID="002";
...
//        obj.date = "05-06-2014";
       ...
       * */
        ...
        val = result.getCount();
        System.out.println("val count:"+val);
...
//            }
        ...
        /////
        String sentVal = "";
        List<String> sentValList = new ArrayList<String>();
...
//            }
            ...
            if(stanClassSentimentTitle.equals("positive")){
                sentVal="0.5";
            }
            else if(stanClassSentimentTitle.equals("negative")){
                sentVal="-0.5";
            }
            else if(stanClassSentimentTitle.equals("neutral")){
                sentVal="0";
            ...
            sentValList.add(newsCounterTitle,sentVal);
            newsCounterTitle++;
            j++;
        }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        for(int vnum=0;vnum<crawledNewsTitle.size();vnum++){
            bw.write(crawledNewsTitle.get(vnum)+" ---> "+crawledNewsSentiTitle.get(vnum)+"---->"+sentValList.get(vnum)+"\n");
        }
        bw.close();
...
//        }
        ...
        /*Used for without crawling getting individual news insertion (mainly for insertion from different sources at a single point rather than crawling from  the single source)
         start*/
        BufferedReader brSource = new BufferedReader(new FileReader("newsSource2.txt"));
        /*end*/
        ...
        int indexDate=0;
        int indexSource=0;
        int news_id=newsIdCounter;
        /*Start*/
        while(brSource.ready()){
            newsSource.add(indexSource,brSource.readLine());
            indexSource++;
        }
        /*end*/
        while(brLink.ready()){
        ...
        System.out.println(sentValList);
        for(k=0;k<newsCounterTitle;k++) {
            dyn.addPropertyGuruItem(tableName,news_id ,crawledNewsSentiTitle.get(k),crawledNewsTitle.get(k) ,"15-07-2014",newsSource.get(k),newsDate.get(k),newsLink.get(k),sentValList.get(k));
            news_id++;
        }
